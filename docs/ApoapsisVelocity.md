...
ApoapsisVelocity[a, e, gm] computes the apoapsis velocity for an orbit with semi-major axis `a`, eccentricity `e`, and gravitational parameter `gm`.
...
```wolfram
ApoapsisVelocity[7000000.0, 0.1, 3.986004415*^14]
...
```wolfram
ApoapsisVelocity[Quantity[7000, "Kilometers"], 0.1, Quantity[3.986004415*^14, "Meters"^3/"Seconds"^2]]
(* Quantity[6825.662019, ("Meters")/("Seconds")] *)
```
