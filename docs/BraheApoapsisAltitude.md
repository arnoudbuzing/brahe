...
BraheApoapsisAltitude[a, e, rBody] computes the apoapsis altitude for an orbit with semi-major axis `a`, eccentricity `e`, and body radius `rBody`.
...
```wolfram
BraheApoapsisAltitude[7000000.0, 0.1, 6378136.3]
...
```wolfram
BraheApoapsisAltitude[Quantity[7000, "Kilometers"], 0.1, Quantity[6378.1363, "Kilometers"]]
(* Quantity[1321863.7, "Meters"] *)
```
